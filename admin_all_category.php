		...
		<div class="row">
			...
			<div class="col m9 center contentwrap">
				<div class="card-panel">
					<span>
						<a href="admin_all_category.php" class="orange-text text-lighten-1">
							<h4 class="center">All Categories</h4>
						</a>
						<table class="striped">
							<tr>
								<th>Category</th><th>Delete</th>
							</tr>
						<?php
						include 'dbconnect.php';
						...
						while($row = mysqli_fetch_array($query,MYSQLI_ASSOC)){?>
							...
							<tr>
								...
								<td><a href="deletecat.php?id=<?php echo $row["id"]; ?>" 
											class="button" 
