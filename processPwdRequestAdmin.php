...
if( isset($_POST) && isset($_REQUEST['action'])=='resetPwdAdmin' ){
    ...
    if( $password == $conpass ){
        ...
        if( $query ){
            ...
            if( $count == 1 ) {
                ...
                $update_stat = "update admin set password='$goodpwd' where email='$email'";
                ...
                if( $updateQuery ){
                    ...
                    echo "<script type='text/javascript'> document.location = 'resetAdmin.php?status=$message'; </script>";
                }// End if-update
            } else{
